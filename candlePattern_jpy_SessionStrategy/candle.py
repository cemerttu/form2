# Complete working code with backtest, strategy, and charting
...
# ========== Chart: Candlestick + Equity + Trades ==========
def plot_candlestick_with_equity_and_trades(df, equity_curve, trades, start_index=0, num_rows=150):
